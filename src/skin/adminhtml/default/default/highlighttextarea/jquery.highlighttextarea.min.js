...
(function(jQuery){
    ...
    Highlighter.prototype.highlight = function() {
        var text = Utilities.htmlEntities(this.jQueryel.val()),
            that = this;
        ...
        jQuery.each(this.settings.words, function(color, words) {
            text = text.replace(
                ...
                function(match, contents, offset, s) {
                    if(match.substring(0,3) == 'amp' || match.substring(0,3) == '&lt' || match.substring(0,3) == '&gt') {
                        return match;
                    }
                    else {
                        return match.substring(0,3) + '<mark style="background-color:' + color + ';">' + match.substr(3) + '</mark>';
                    }
                }
            );
        });
