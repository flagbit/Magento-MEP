...
class Flagbit_MEP_Block_Adminhtml_Profil_View_New_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	/**
     * Class Constructor
     * 
	...
	protected function _beforeToHtml()
	{
		$this->addTab('form_section', array(
				...
				'content' => $this->getLayout()->createBlock('mep/adminhtml_profil_view_new_tab_general')->toHtml(),
		));
