...
ALTER TABLE `{$this->getTable('mep/mapping')}` ADD COLUMN `inheritance` BOOLEAN DEFAULT FALSE;
ALTER TABLE `{$this->getTable('mep/mapping')}` ADD COLUMN `inheritance_type` VARCHAR (100) DEFAULT '';
