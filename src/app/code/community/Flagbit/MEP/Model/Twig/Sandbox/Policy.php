...
class Flagbit_MEP_Model_Twig_Sandbox_Policy extends Twig_Sandbox_SecurityPolicy
{
    ...
    {
        $this->allowedTags = array('spaceless', 'if', 'set', 'block', 'do', 'filter');
        $this->allowedFilters = array('date', 'date_modify', 'format', 'replace', 'number_format', 'number_format_array', 'url_encode', 'json_encode', 'convert_encoding', 'title', 'capitalize', 'nl2br', 'upper', 'lower', 'striptags', 'join', 'split', 'reverse', 'abs', 'length', 'sort', 'default', 'keys', 'escape', 'raw', 'merge', 'slice', 'trim', 'last', 'first');
