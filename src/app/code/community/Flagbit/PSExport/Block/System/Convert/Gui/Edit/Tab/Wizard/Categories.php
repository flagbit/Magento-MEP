 ...
 */
class Flagbit_PSExport_Block_System_Convert_Gui_Edit_Tab_Wizard_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('flagbit/psexport/wizard/categories.phtml');
    }
